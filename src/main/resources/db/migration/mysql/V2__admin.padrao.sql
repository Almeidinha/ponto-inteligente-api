...
VALUES (NULL, '82198127000121', CURRENT_DATE(), CURRENT_DATE(), 'Almeidinha IT2');
...
VALUES (NULL, '16248890935', CURRENT_DATE(), CURRENT_DATE(), 'admin@almeidaIT.com', 'ADMIN', 'ROLE_ADMIN', NULL, NULL, 
